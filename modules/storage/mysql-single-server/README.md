...
| `skuCapacity`                  | `int`          | No       | Azure database for MySQL compute capacity in vCores (2,4,8,16,32)                                                                                               |
| `SkuSizeMB`                    | `int`          | No       | Azure database for MySQL Sku Size                                                                                                                               |
| `SkuTier`                      | `string`       | No       | Azure database for MySQL pricing tier                                                                                                                           |
| `skuFamily`                    | `string`       | No       | Azure database for MySQL sku family                                                                                                                             |
